...
<Figure title="UMAP Projections of GAT Embeddings">
  ...
  {:else}
    ...
    <Plot x={{ label: 'UMAP 1' }} y={{ label: 'UMAP 2' }} color={{ domain: ['Benign', 'Dos', 'Fuzzy', 'Gear', 'Rpm', 'Flooding', 'Malfunction'], range: ['#4E79A7', '#E15759', '#F28E2B', '#59A14F', '#76B7B2', '#B07AA1', '#9C755F'], legend: true }} height={500}>
