...
2. **`mdast-util-to-markdown` adoption** — shipped. `tools/tmlr/build.mjs` replaces `build.py`, ~1300 lines deleted. 29 semantic-property tests via `node --test`.
