...
::: {#fig-results-table}
```{=html}
<iframe src="https://frenken-lab.github.io/kd-gat-paper/assets/html/submission/results-table.html" width="100%" height="500" frameborder="0" loading="lazy"></iframe>
```
