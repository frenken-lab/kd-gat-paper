...
: Comparison of IDS frameworks. Columns highlight detection paradigm, evaluation breadth, and whether fusion is learned. Our approach is the only framework combining heterogeneous graph experts with adaptive fusion across six datasets.
:::
