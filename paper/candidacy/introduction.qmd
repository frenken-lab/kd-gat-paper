...
::: {#fig-gsn-thesis .gsn-figure}
```{=html}
<iframe src="https://frenken-lab.github.io/kd-gat-paper/assets/html/submission/gsn-thesis.html" width="100%" height="500" frameborder="0" loading="lazy"></iframe>
```
...
: Expert Coverage Across Detection Dimensions
:::
