...
To assess the contribution of each model component, we perform ablation experiments comparing standalone and fused architectures. @tbl-ablation-compact summarizes F1-scores for the GAT-only and fusion setups across all datasets.
...
{{< include _generated/ablation/leaderboard.qmd >}}
